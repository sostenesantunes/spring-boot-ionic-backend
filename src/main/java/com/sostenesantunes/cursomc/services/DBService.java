...
import com.sostenesantunes.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantatiateTestDatabase() throws ParseException {
		...
		Categoria cat3 = new Categoria(null, "Perfumária");
		...
		Produto p6 = new Produto(null, "Colcha", 210.00);
		Produto p7 = new Produto(null, "TV Smart 40 Polegadas", 2200.00);
		Produto p8 = new Produto(null, "Roçadeira", 900.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Costa", "sostenesantunes@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pass.encode("123456"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","983838393"));
		cli1.addPerfil(Perfil.CLIENTE);
		
		Cliente cli2 = new Cliente(null, "Bruno Catalão", "antunes@gmail.com", "53713399069", TipoCliente.PESSOAFISICA, pass.encode("123456"));
		cli2.getTelefones().addAll(Arrays.asList("25348978","96543388"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Rua Machado de Assis", "145", "Sala 101", "Centro", "34586381", cli2, c2);
		...
		Pedido ped1 = new Pedido(null,sdf.parse("30/09/2019 10:35"), cli1, e1);
